...
if False:  # MYPY
    ...
    from ruamel_yaml.compat import VersionType  # NOQA

from ruamel_yaml.compat import string_types, _DEFAULT_YAML_VERSION  # NOQA
from ruamel_yaml.error import *  # NOQA
from ruamel_yaml.nodes import MappingNode, ScalarNode, SequenceNode  # NOQA
from ruamel_yaml.util import RegExp  # NOQA
