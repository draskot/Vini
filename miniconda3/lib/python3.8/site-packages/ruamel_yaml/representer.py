...
from ruamel_yaml.compat import text_type, binary_type, to_unicode, PY2, PY3, ordereddict
from ruamel_yaml.compat import nprint, nprintf  # NOQA
from ruamel_yaml.scalarstring import (
    LiteralScalarString,
    FoldedScalarString,
