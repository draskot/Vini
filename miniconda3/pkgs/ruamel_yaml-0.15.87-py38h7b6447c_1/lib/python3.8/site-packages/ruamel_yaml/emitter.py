...
import sys
from ruamel_yaml.error import YAMLError, YAMLStreamError
from ruamel_yaml.events import *  # NOQA

# fmt: off
from ruamel_yaml.compat import utf8, text_type, PY2, nprint, dbg, DBG_EVENT, \
    check_anchorname_char
# fmt: on

if False:  # MYPY
    from typing import Any, Dict, List, Union, Text, Tuple, Optional  # NOQA
    from ruamel_yaml.compat import StreamType  # NOQA
