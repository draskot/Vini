...
from ruamel_yaml.nodes import (SequenceNode, MappingNode, ScalarNode)
from ruamel_yaml.compat import (utf8, builtins_module, to_str, PY2, PY3,  # NOQA
                                ordereddict, text_type, nprint, nprintf, version_tnf,
                                Hashable, MutableSequence, MutableMapping)
from ruamel_yaml.comments import *                               # NOQA
from ruamel_yaml.comments import (CommentedMap, CommentedOrderedMap, CommentedSet,
                                  CommentedKeySeq, CommentedSeq, TaggedScalar,
                                  CommentedKeyMap)
from ruamel_yaml.scalarstring import (SingleQuotedScalarString, DoubleQuotedScalarString,
                                      LiteralScalarString, FoldedScalarString,
                                      PlainScalarString, ScalarString,)
from ruamel_yaml.scalarint import ScalarInt, BinaryInt, OctalInt, HexInt, HexCapsInt
from ruamel_yaml.scalarfloat import ScalarFloat
from ruamel_yaml.scalarbool import ScalarBoolean
...
class RoundTripConstructor(SafeConstructor):
    ...
    def construct_rt_sequence(self, node, seqtyp, deep=False):
        ...
        if node.anchor:
            from ruamel_yaml.serializer import templated_id
