#  tests for python-dateutil-2.8.1-py_0 (this is a generated file);
print('===== testing package: python-dateutil-2.8.1-py_0 =====');
...
print('===== python-dateutil-2.8.1-py_0 OK =====');
print("import: 'dateutil'")
import dateutil

print("import: 'dateutil.rrule'")
import dateutil.rrule

print("import: 'dateutil.parser'")
import dateutil.parser

print("import: 'dateutil.tz'")
import dateutil.tz

print("import: 'dateutil.zoneinfo'")
