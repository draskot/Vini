...
#
# $Header: /opt/cvs/python/packages/share1.5/mglutil/math/kinematics.py,v 1.16.18.1 2017/07/26 22:35:42 annao Exp $
#
...
class Kinematics:
    ...
    def __applyTorsion(self, node, parent_mtx):
        ...
        mtx = rotax( numpy.array(node.a.coords),
                     numpy.array(node.b.coords),
                     node.angle * self.rads_per_degree, transpose=1)

        # node_mtx = numpy.dot(parent_mtx, mtx)
