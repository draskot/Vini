...
#
# $Header: /opt/cvs/python/packages/share1.5/mglutil/math/kinematicstest.py,v 1.8.18.1 2017/07/26 22:35:42 annao Exp $
#
...
##          ko = Kinematics(self.known_points, self.torTree, tolist=0)
##          result = numpy.around(ko.applyAngList([90.,-90.,0.])[:,:3],
