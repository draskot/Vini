...
# $Author: annao $
# $Header: /opt/cvs/python/packages/share1.5/mglutil/splashregister/register.py,v 1.27.4.1 2017/07/26 22:35:43 annao Exp $
# $Date: 2017/07/26 22:35:43 $
# $Id: register.py,v 1.27.4.1 2017/07/26 22:35:43 annao Exp $
