...
#$Header: /opt/cvs/python/packages/share1.5/mglutil/gui/BasicWidgets/Tk/colorWidgets.py,v 1.34.6.1 2017/07/26 22:35:41 annao Exp $
#
#$Id: colorWidgets.py,v 1.34.6.1 2017/07/26 22:35:41 annao Exp $
#
...
class PaletteChooser():    
    ...
    def setButtonsColor(self, ramp):
        for index, button in enumerate(self.buttons):
            col = ToHEX(ramp[index])
            button.configure(bg = col, activebackground=col, selectcolor=col)
