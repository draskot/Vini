...
#
#$Header: /opt/cvs/Volume/IO/WriteVolumeToFile.py,v 1.3.16.1 2017/07/28 01:09:20 annao Exp $
#
#$Id: WriteVolumeToFile.py,v 1.3.16.1 2017/07/28 01:09:20 annao Exp $
#
import struct, os
