...
#
# $Header: /opt/cvs/MolKit2/molecule.py,v 1.6.2.1 2017/07/26 22:03:40 annao Exp $
# 
...
class Molecule(TreeObject):
    ...
    ## def __del__(self):
    ##     del self._ag
    ##     print 'deleteing molecule', self.name
...
##
    ...
    def selectMolKit(self, selStr):
        """select atoms in this molecule usignthe MolKit syntax
