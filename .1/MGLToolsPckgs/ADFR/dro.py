...
#########################################################################
#
# $Header: /opt/cvs/ADFR/dro.py,v 1.12 2017/07/08 02:10:42 sanner Exp $
#
# $Id: dro.py,v 1.12 2017/07/08 02:10:42 sanner Exp $
#
...
class DockingResultsObject:
    ...
    def load(self, filename):
        ...
        mf = MapsFile(self._dockingData['receptorMapsFile'])
        mf.unzipMaps()
        self.mf = mf
        ...
        self._flexRes = self._gridData['flexResStr']
    ...
    def makeScorer(self):
        ...
        if self._gridData['covalentBond']:
