...
#########################################################################
#
# $Header: /opt/cvs/ADFR/GA.py,v 1.14 2017/04/14 17:50:25 sanner Exp $
#
...
class GenomePy(Genome):
    ...
    def __init__(self, ft, scorer, scaleRE=None):
...
class IndividualPy(Individual):
    ...
    def score(self):
        ...
        #self._score = genome.getTotalScore()
