...
#########################################################################
#
# $Header: /opt/cvs/ADFR/utils/optParser.py,v 1.25.2.2 2017/09/28 23:44:34 annao Exp $
#
# $Id: optParser.py,v 1.25.2.2 2017/09/28 23:44:34 annao Exp $
#
import argparse, sys
...
class AGFRParser(ArgumentParser):
    ...
    def __init__(self, *args, **kw):
        ...
        self.add_argument('-R', '--processMaps', dest="fixMaps",
                          action="store_true", default=False,
                          help="Post-process maps to remove points inside the receptor surface and create a repulsive gradient from the core of the receptor toward the surface. If the option is not used the original maps computed by AutoGrid4 are saved in the target file.")
