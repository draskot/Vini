...
#########################################################################
#
# $Header: /opt/cvs/ADFR/utils/runADFR.py,v 1.34.2.1 2017/08/21 22:23:11 annao Exp $
#
# $Id: runADFR.py,v 1.34.2.1 2017/08/21 22:23:11 annao Exp $
#
#
...
class runADFR:
    ...
    def __call__(self, **kw):
        ...
        self.myprint('packaging docking results in to %s.dro'%self.outputBaseName,
                     newline= False)
