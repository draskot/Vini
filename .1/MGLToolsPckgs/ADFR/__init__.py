...
#########################################################################
#
# $Header: /opt/cvs/ADFR/__init__.py,v 1.32.2.1 2017/08/01 00:35:32 annao Exp $
#
...
class ADFR:
    ...
    def __init__(self, ligand, mapsFolder, receptor=None,
        ...
        *anchor*.npy in mapsFolder. Else if tpointsFilename starts with a path
        ...
        if not covLigAnchorAt and tpointsFilename is not None and not fixedRoot:
        ...
        elif isinstance(ligFT.motions[0],FTDiscreteTranslation):
    ...
    def createGA(self, pop, referenceLigFile=None, quickmini=None, hardmini=None, seedValue=-1, RMSDMatching='hungarian' ):
