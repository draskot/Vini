...
#########################################################################
#
# $Header: /opt/cvs/ADFR/LigandFT.py,v 1.14 2017/07/12 02:40:08 sanner Exp $
#
...
class LigandFT:
    ...
    def __init__(self, mol, torTree, transPoints=None, covalentLigandAnchorAtoms=False, fixedRoot=False):
