...
#########################################################################
#
# $Header: /opt/cvs/PmvApp/GUI/Qt/PmvGUI.py,v 1.59.4.5 2017/10/12 23:53:00 annao Exp $
#
# $Id: PmvGUI.py,v 1.59.4.5 2017/10/12 23:53:00 annao Exp $
#
...
class PmvViewer(Viewer, QtGui.QWidget):
    ...
    def getFilename(self, filenames=None):
        filenames, filter = QtGui.QFileDialog.getOpenFileNames(
            ...
            self.tr("PDB Files (*.pdb);; PDBQT Files (*.pdbqt);; MOL2 Files (*.mol2);; SDF Files (*.sdf);; MMTF Files (*.mmtf);; Session Files (*.psf);; All files (*) "))
