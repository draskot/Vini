...
#
# $Header: /opt/cvs/PmvApp/GUI/Qt/advancedParamGui.py,v 1.1.4.2 2017/10/17 01:17:49 annao Exp $
#
...
class ColorsWidget(QtGui.QWidget):
    ...
    def __init__(self, gui, geomNames=[], parent=None):
        ...
        colorCmdsNames = ['atom type', 'molecules', 'chains',
        ...
        for name in colorCmdsNames:
            cb = CallbackFunction(self.color_cb, geomNames, self.colorCmds[name])
...
class SBCustomizeWidget(IndexedGeomCustomizeWidget):
    ...
    def addColorsWidgets(self):
        ...
        sticksColorLayout = QtGui.QVBoxLayout()
