...
#
# $Header: /opt/cvs/PmvApp/displayCmds.py,v 1.14.4.2 2017/10/17 01:13:07 annao Exp $
#
# $Id: displayCmds.py,v 1.14.4.2 2017/10/17 01:13:07 annao Exp $
#
...
class DisplayLines(DisplayCommand):
    ...
    def initializeMolForCmd(self, mol):
        ...
        if mol._ag.getData('colorsIndices_lines') is None:
            mol._ag.setData('colorsIndices_lines', numpy.zeros(len(mol._ag)))
