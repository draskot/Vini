...
#########################################################################
#
# $Header: /opt/cvs/AutoSite/utils/clusterTPoints.py,v 1.4.2.1 2017/09/11 17:31:29 sanner Exp $
#
# $Id: clusterTPoints.py,v 1.4.2.1 2017/09/11 17:31:29 sanner Exp $
#
import numpy, random
...
class DensityClustering:
    ...
    def findClustersD(self, ptsIndices, cVolcut=20):
        """returns list of contiguous clusters of filter points with every
        point in a cluster having the specified number of neighbors. """
	#print "wathch me", self.spacing
        ...
        while True:
            ...
            ci += 1
            if ci<len(cluster): # more points in thsi cluster can be checked for neighbors
