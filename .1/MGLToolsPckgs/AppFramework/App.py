...
#########################################################################
#
# $Header: /opt/cvs/AppFramework/App.py,v 1.21.4.1 2017/07/28 00:58:00 annao Exp $
#
# $Id: App.py,v 1.21.4.1 2017/07/28 00:58:00 annao Exp $
#

"""
define a base class AppFramework that support lazy loading of commands
"""
...
class AppFramework:
    ...
    def setOnAddObjectCmd(self, objType, cmds, argsList=None, kwList=None):
        ...
        oldCmds <- setOnAddObjectCmd(cmds)

        objType id the type of bjects for which we define the list
        cmds is a list of commands
        args if provides has to be a list of tuples of the same length as cmds
        kw if provides has to be a list of dict of the same length as cmds
